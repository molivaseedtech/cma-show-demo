...
export const PACKAGE_SCHEMA = {
  ...
  properties: {
    title: { type: 'string', description: 'Editorial blog headline.' },
    episodeTitle: { type: 'string', description: 'Podcast episode headline.' },
    ...
    bodyHtml: { type: 'string', description: 'Article body using only p, h2, ul, ol, li, strong, em tags.' },
    chapters: {
      type: 'array',
      items: {
        type: 'object',
...
- The article should open with a short morning greeting, prioritize useful news, then fun/personal segments, and be easy to skim.
